                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <small>If you doesn't want to change password , miss the password!</small>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <select name="user_status" class="form-control">
                                        <option {{$users->user_status=="1" ? "selected=''" : ""}} value="1">Active
                                        </option>
                                        <option {{$users->user_status=="0" ? "selected=''" : ""}} value="0">Passive
                                        </option>
                                    </select>
                                </div>
                            </div>
