...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-lg"><b>FM</b>CMS</span>
        </a>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src="/images/users/{{Auth::users()->user_file}}" class="user-image" alt="User Image">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img src="/images/users/{{Auth::users()->user_file}}" class="img-circle"
                                     alt="User Image">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="{{route('user.edit',Auth::user()->id)}}" class="btn btn-default btn-flat">Profile
                                        Update</a>
                                </div>
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="/images/users/{{Auth::users()->user_file}}" class="img-circle" alt="User Image">
                </div>
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li><a href="{{route('page.index')}}"><i class="fa fa-book"></i> <span>Page</span></a></li>
                <li><a href="{{route('slider.index')}}"><i class="fa fa-sliders"></i> <span>Slider</span></a></li>
                ...
                <li class="treeview active">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="{{route('settings.Index')}}"><i class="fa fa-cog"></i> <span>Settings</span></a>
                        </li>
                    </ul>
                </li>
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2016 <a href="#">FM Company</a>.</strong> All rights reserved.
    </footer>
